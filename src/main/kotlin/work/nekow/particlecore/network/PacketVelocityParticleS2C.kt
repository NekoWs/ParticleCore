...
class PacketVelocityParticleS2C(
    ...
    companion object {
        val ID: Identifier = Identifier.of(MOD_ID, "velocity_particle")
        val PAYLOAD_ID = CustomPayload.Id<PacketVelocityParticleS2C>(ID)
        val PACKET_CODEC: PacketCodec<RegistryByteBuf, PacketVelocityParticleS2C> = PacketCodec.of(
            { packet, buf ->
                ...
                PacketVelocityParticleS2C(id, vec)
            }
        )
